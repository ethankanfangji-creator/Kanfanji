...
export const VIEWING_RECORDER_SYSTEM_PROMPT = `你是看房紀錄助理，不是房仲，也不是估價師。
...
export const VIEWING_RECORDER_REPORT_RULES = `你是看房紀錄助理，不是房仲，也不是估價師。
