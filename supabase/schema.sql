-- Base schema for new projects (auth-isolated), not a standalone provisioner.
-- Fresh provisioning must apply every migrate-*.sql forward migration in the
-- order documented by docs/release-migration-runbook.md after this file.
